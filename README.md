...
lenovo-power cpu-limit [PL1 [PL2]]   # watts; only honoured in the 'custom' profile
...
- **Writes fail fast.** A non-interactive caller (keybind, script) gets an error
  rather than a hanging sudo prompt.
...
| CPU PL1 | `firmware-attributes/.../ppt_pl1_spl` | 50-135 W |
| CPU PL2 | `firmware-attributes/.../ppt_pl2_sppt` | 60-210 W |
